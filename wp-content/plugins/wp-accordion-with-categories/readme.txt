...
A quick, easy way to add an responsive Accordions grid for WordPress. By this plugin you can display unlimited accordion with category at same page via short-code.
